...
const PARTICIPATING_COUNTIES = [
  { countyfp: "005", name: "Allegan", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "015", name: "Barry", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "017", name: "Bay", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "021", name: "Berrien", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "025", name: "Calhoun", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "027", name: "Cass", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "037", name: "Clinton", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "045", name: "Eaton", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "049", name: "Genesee", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "055", name: "Grand Traverse", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "065", name: "Ingham", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "067", name: "Ionia", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "073", name: "Isabella", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "075", name: "Jackson", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "077", name: "Kalamazoo", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "081", name: "Kent", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "087", name: "Lapeer", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "091", name: "Lenawee", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "093", name: "Livingston", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "099", name: "Macomb", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "103", name: "Marquette", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "111", name: "Midland", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "115", name: "Monroe", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "117", name: "Montcalm", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "121", name: "Muskegon", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "125", name: "Oakland", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "139", name: "Ottawa", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "145", name: "Saginaw", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "147", name: "St. Clair", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "149", name: "St. Joseph", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "155", name: "Shiawassee", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "157", name: "Tuscola", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "159", name: "Van Buren", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "161", name: "Washtenaw", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "163", name: "Wayne", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Michigan are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
];
